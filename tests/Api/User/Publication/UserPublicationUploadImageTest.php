...
class UserPublicationUploadImageTest extends ApiTestCase
{
    ...
    public function test_upload_not_logged(): void
    {
        ...
        $this->client->request('POST', '/api/user/publications/' . $publication->getId() . '/upload-image', [], ['imageFile' => $file], [
    ...
    public function test_upload_image_publication_not_found(): void
    {
        $user = UserFactory::new()->asBaseUser()->create();
    ...
    public function test_upload_with_no_image(): void
    {
        ...
        $this->client->loginUser($user->_real());
        $this->client->request('POST', '/api/user/publications/' . $publication->getId() . '/upload-image', [], [], [
            'CONTENT_TYPE' => 'multipart/form-data',
        ]);
