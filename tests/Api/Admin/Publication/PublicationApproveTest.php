...
class PublicationApproveTest extends ApiTestCase
{
    ...
    public function test_approve_publication(): void
    {
        ...
        $this->assertSame(Publication::STATUS_PENDING, $publication->status);
        $this->assertNull($publication->publicationDatetime);
    ...
    public function test_approve_publication_not_logged(): void
    {
        $user = UserFactory::new()->asBaseUser()->create();
    ...
    public function test_approve_publication_already_online(): void
    {
        $admin = UserFactory::new()->asAdminUser()->create();
        ...
        $this->assertJsonEquals([
            ...
            'detail'      => 'Only pending publications can be approved',
            'status'      => 400,
            'type'        => '/errors/400',
            'description' => 'Only pending publications can be approved',
        ]);
    }

    public function test_approve_publication_draft(): void
    {
        $admin = UserFactory::new()->asAdminUser()->create();
