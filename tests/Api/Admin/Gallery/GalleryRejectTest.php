...
class GalleryRejectTest extends ApiTestCase
{
    use ApiTestAssertionsTrait;

    public function test_reject_gallery(): void
    {
    ...
    public function test_reject_gallery_with_no_admin(): void
    {
        ...
        $this->client->request('POST', '/api/admin/galleries/' . $gallery->id . '/reject', [], [], [
            'CONTENT_TYPE' => 'application/ld+json',
        ], '{}');
        $this->assertResponseStatusCodeSame(Response::HTTP_FORBIDDEN);
    }

    public function test_reject_gallery_not_logged(): void
    {
        $user = UserFactory::new()->asBaseUser()->create();
    ...
    public function test_reject_gallery_already_online(): void
    {
        $admin = UserFactory::new()->asAdminUser()->create();
        ...
        $this->assertJsonEquals([
            ...
            'detail'      => 'Only pending galleries can be rejected',
            'status'      => 400,
            'type'        => '/errors/400',
            'description' => 'Only pending galleries can be rejected',
        ]);
    }

    public function test_reject_gallery_draft(): void
    {
        $admin = UserFactory::new()->asAdminUser()->create();
