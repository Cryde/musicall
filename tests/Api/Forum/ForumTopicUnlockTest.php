...
#[ResetDatabase]
class ForumTopicUnlockTest extends ApiTestCase
{
    ...
    public function test_unlock_unauthenticated_returns_401(): void
    {
        $this->createTopic(['isLocked' => true]);

        $this->client->jsonRequest('POST', '/api/forums/topics/test-topic/unlock', [], [
    ...
    public function test_unlock_unknown_slug_returns_404(): void
    {
        $user = UserFactory::new()->asBaseUser()->create();
        $this->client->loginUser($user);

        $this->client->jsonRequest('POST', '/api/forums/topics/does-not-exist/unlock', [], [
            'CONTENT_TYPE' => 'application/ld+json',
            'HTTP_ACCEPT' => 'application/ld+json',
        ]);
    ...
    public function test_unlock_by_random_user_returns_403(): void
    {
    ...
    public function test_unlock_by_author_succeeds(): void
    {
        $topic = $this->createTopic(['isLocked' => true]);
    ...
    public function test_unlock_by_admin_succeeds(): void
    {
        $topic = $this->createTopic(['isLocked' => true]);
    ...
    public function test_unlock_already_unlocked_is_idempotent(): void
    {
