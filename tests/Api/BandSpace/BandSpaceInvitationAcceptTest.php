...
class BandSpaceInvitationAcceptTest extends ApiTestCase
{
    ...
    public function test_accept_notifies_the_inviter(): void
    {
        $admin = UserFactory::new()->asBaseUser()->create();
        $invitee = UserFactory::new()->create(['username' => 'invitee', 'email' => 'invitee@example.com']);
        $bandSpace = BandSpaceFactory::new(['name' => 'The Rockers'])->create();
        ...
        $this->assertSame(NotificationType::BandSpaceInvitationAccepted, $inviterNotifications[0]->type);
        $this->assertSame([
    ...
    public function test_notification_failure_does_not_break_the_accept(): void
    {
        ...
        // A notification failure must never roll back or 500 the accept (epic #689 contract item 1).
