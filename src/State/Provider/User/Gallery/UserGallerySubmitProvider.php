...
/**
 * @implements ProviderInterface<UserGallerySubmit>
 */
readonly class UserGallerySubmitProvider implements ProviderInterface
{
    ...
    public function provide(Operation $operation, array $uriVariables = [], array $context = []): UserGallerySubmit
    {
        ...
        if ($gallery->getStatus() !== Gallery::STATUS_DRAFT) {
            throw new AccessDeniedHttpException('Cette galerie ne peut pas etre soumise');
        }
