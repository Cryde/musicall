    ...
    operations: [
        new GetCollection(
            ...
            parameters: [
                ...
                'due_date_from' => new QueryParameter(key: 'due_date_from', constraints: [new Assert\Date()]),
                'due_date_to' => new QueryParameter(key: 'due_date_to', constraints: [new Assert\Date()]),
                'overdue' => new QueryParameter(key: 'overdue'),
            ],
        ),
        new Get(
