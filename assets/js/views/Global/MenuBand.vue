        ...
        <div class="flex-1 flex items-start gap-4 px-6 lg:px-0 py-4 lg:py-0 flex-col lg:flex-row">
          ...
          <RouterLink :to="{name: 'app_home'}" custom v-slot="{ href, navigate }">
            <a
              :href="href"
              @click="navigate"
              class="flex items-center lg:ml-10 text-xs gap-2 p-2 rounded-lg cursor-pointer transition-colors duration-150 border w-full lg:w-auto border-transparent hover:underline"
            >
