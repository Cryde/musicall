...
import bassImg from '../../../image/course/basse.webp'
import drumImg from '../../../image/course/batterie.webp'
import miscImage from '../../../image/course/divers.webp'
import guitarImg from '../../../image/course/guitare.webp'
import maoImg from '../../../image/course/mao.webp'
...
onMounted(async () => {
  if (route.params.slug) {
    ...
    isInitialized.value = true
    await Promise.all([coursesStore.loadCategories(), infiniteHandler()])
  }
})
