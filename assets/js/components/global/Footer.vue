  ...
  <footer class="footer">
    <div class="container">
      <div class="columns">
        <div class="column">
          <h3>
            <router-link :to="{ name: 'home' }" class="has-text-dark"><i class="fas fa-home fa-fw"></i> MusicAll</router-link>
          </h3>
        </div>
        <div class="column">
          <h3>
            <router-link :to="{ name: 'publication' }" class="has-text-dark"><i class="fas fa-newspaper fa-fw"></i> Publications
            </router-link>
          </h3>
          <ul>
            <li v-if="isLoading">
        ...
        <div class="column">
          <h3>
            <router-link :to="{ name: 'course_index' }" class="has-text-dark"><i class="fas fa-graduation-cap fa-fw"></i> Cours</router-link>
          </h3>
          <ul>
            <li v-if="isLoading">
              <spinner/>
        ...
        <div class="column">
          <h3 >
            <router-link :to="{ name: 'search_index' }" class="has-text-dark"><i class="fas fa-stream fa-fw"></i> Recherche</router-link>
          </h3>
        </div>
        <div class="column">
          <h3>
            <router-link :to="{ name: 'forum_index' }" class="has-text-dark"><i class="far fa-comments fa-fw"></i> Forum</router-link>
          </h3>
        </div>
        <div class="col-lg-4 mt-3 mt-lg-0 social">
          <h3 class="has-text-dark"><i class="far fa-thumbs-up"></i> Nous suivre</h3>
