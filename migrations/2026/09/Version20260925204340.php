...
/**
 * A chat message can carry a voice note (#974), with its duration as ffprobe measured it.
 *
...
final class Version20260925204340 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE message ADD voice_note_file_id CHAR(36) DEFAULT NULL, ADD voice_note_duration_seconds SMALLINT DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        $this->addSql('ALTER TABLE message DROP voice_note_file_id, DROP voice_note_duration_seconds');
    }
}
