 ...
 */
final class Version20260131084251 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_teacher_profile (id CHAR(36) NOT NULL, description LONGTEXT DEFAULT NULL, years_of_experience INT DEFAULT NULL, student_levels JSON NOT NULL, age_groups JSON NOT NULL, course_title VARCHAR(255) DEFAULT NULL, offers_trial TINYINT NOT NULL, trial_price INT DEFAULT NULL, creation_datetime DATETIME NOT NULL, update_datetime DATETIME DEFAULT NULL, user_id CHAR(36) NOT NULL, view_cache_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_5E494BC1A76ED395 (user_id), UNIQUE INDEX UNIQ_5E494BC1F91C231C (view_cache_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE user_teacher_profile_location (id CHAR(36) NOT NULL, type VARCHAR(20) NOT NULL, address VARCHAR(255) DEFAULT NULL, city VARCHAR(100) DEFAULT NULL, country VARCHAR(100) DEFAULT NULL, latitude VARCHAR(255) DEFAULT NULL, longitude VARCHAR(255) DEFAULT NULL, radius INT DEFAULT NULL, teacher_profile_id CHAR(36) NOT NULL, INDEX IDX_4C025C3646E5B018 (teacher_profile_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
