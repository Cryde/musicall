 ...
 *     }>,
 * }
 * @psalm-type ElasticallyConfig = array{
 *     connections?: list<array{ // Default: []
 *         client?: list<mixed>,
 *         mapping_directory?: scalar|Param|null, // Path to the mapping directory (in YAML)
 *         mapping_provider_service?: scalar|Param|null, // For custom mapping provider
 *         index_class_mapping: list<scalar|Param|null>,
 *         prefix?: scalar|Param|null, // A prefix for all elasticsearch indices // Default: null
 *         bulk_size?: int|Param, // When running indexation of lots of documents, this setting allow you to fine-tune the number of document threshold. // Default: 100
 *         serializer?: array{ // Configuration for the serializer
 *             context_mapping?: list<mixed>,
 *             context_builder_service?: scalar|Param|null, // For custom context builder
 *         },
 *     }>,
 *     default_connection?: scalar|Param|null, // The default connection name. Useful for autowire // Default: null
 * }
